...
@Autonomous
public class AutoBlueSortV3 extends OpMode {
    ...
    private final Pose endPose = new Pose(59.1, 105, Math.toRadians(155));


    private PathChain startToDetectTag, detectTagToCloseShoot, closeShootToStartClose, startCloseToEndClose, endCloseToMiddleShoot, middleShootToStartMid, startMidToEndMid,endMidToMidMid, midMidToMiddleShoot, middleShootToStartFar, startFarToEndFar, endFarToEnd;
    ...
    public void buildPaths(){
        ...
        startMidToEndMid = follower.pathBuilder()
                ...
                .build();
        endMidToMidMid = follower.pathBuilder()
                .addPath(new BezierLine(endMid, midMid))
                .setLinearHeadingInterpolation(endMid.getHeading(), midMid.getHeading())
                .build();
        midMidToMiddleShoot = follower.pathBuilder()
                .addPath(new BezierLine(middleShoot, endPose))
                .setLinearHeadingInterpolation(midMid.getHeading(), endPose.getHeading())
                .build();
...
//                    robotHardware.stopIntake();
           //         robotHardware.stopSpin();
                    ...
                    setPathState(PathState.MID_MID_TO_LAUNCH_MID);
                }
                break;
