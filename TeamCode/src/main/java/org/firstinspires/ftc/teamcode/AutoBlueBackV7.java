...
@Autonomous
public class AutoBlueBackV7 extends OpMode {
    ...
    private final Pose farShootPose = new Pose(57.3, 12, Math.toRadians(135));
        ...
        switch(pathState){
            ...
            case PRESET_CORNER_TO_SHOOT:
                if(!follower.isBusy()){
                    ...
                    robotHardware.startIntake();
                    robotHardware.stopSpin();
                    setPathState(PathState.ADJUST_LAUNCHER_PRESET_CORNER);
                }
                break;
